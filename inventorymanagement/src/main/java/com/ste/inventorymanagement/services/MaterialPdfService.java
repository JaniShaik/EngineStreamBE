...
//S.No, Material Number, Material Description, Last PO Unit Price, Last 1st Year Issue Quantity, Last 2nd Year Issue Quantity, Last 3rd Year Issue Quantity
            ...
            for (Material material : materials) {
              ...
              //S.No, Material Number, Material Description, Last PO Unit Price, Last 1st Year Issue Quantity, Last 2nd Year Issue Quantity, Last 3rd Year Issue Quantity
                ...
                cell = new PdfPCell(new Phrase(getPhraseData((material.getMaterialNumber()))));
                cell.setPaddingLeft(5);
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);

                cell = new PdfPCell(new Phrase(getPhraseData(material.getMaterialDescription())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                cell.setPaddingRight(5);
                table.addCell(cell);
                
                cell = new PdfPCell(new Phrase(getPhraseData(material.getLastPOUnitPrice().toString())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                cell.setPaddingRight(5);
                table.addCell(cell);
                
                cell = new PdfPCell(new Phrase(getPhraseData(material.getLast1stYearIssueQuantity())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                cell.setPaddingRight(5);
                table.addCell(cell);
                
                cell = new PdfPCell(new Phrase(getPhraseData(material.getLast2ndYearIssueQuantity())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                cell.setPaddingRight(5);
                table.addCell(cell);
                
                cell = new PdfPCell(new Phrase(getPhraseData(material.getLast3rdYearIssueQuantity())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
                cell.setPaddingRight(5);
                table.addCell(cell);
